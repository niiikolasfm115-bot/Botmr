...
IVASMS_DASHBOARD = {
    ...
    "username": "zeinnnn12@gmail.com",
    "password": "Yaj7WeS2@aN9GTk",
...
USERNAME = "zeinnnn12@gmail.com"
PASSWORD = "Yaj7WeS2@aN9GTk"
BOT_TOKEN = '8633770228:AAEkmn3bUAhoVfbNtL9iaB8YAJDL3Tl-Pvw'
CHAT_IDS = [
    "-1003908608560",
]
REFRESH_INTERVAL = 3
...
ADMIN_IDS = [8233900497, 8233900497]  
DB_PATH = "bot1.db"
...
def send_welcome(message):
    ...
    # لو مستotpدم عادي والكوكيز منتهية يشوف رسالة صيانة
    if not is_admin(user_id) and not IVASMS_DASHBOARD.get('is_logged_in', False):
        maintenance_caption = (
            "<b>❍─── <u>✦𝗡𝗜𝗞𝗢𝗟𝗔𝗦✦𝗡𝗨𝗠𝗡𝗘𝗥𝗗 𝗢𝗧𝗣</u> ───❍</b>\n\n"
    ...
    fancy_text = (
        "<b>❍<u>✦𝗡𝗜𝗞𝗢𝗟𝗔𝗦✦𝗡𝗨𝗠𝗡𝗘𝗥𝗗 𝗢𝗧𝗣</u>❍</b>\n\n"
        "<b>🔋<u>مـنـور بـوت ارقـام يـ صـ 😁✌️</u></b>\n\n"
        "<b>🎓<u>𝒐𝒘𝒏𝒆𝒓</u> : <a href='tg://user?id=8215895035'>.⤹​✦𝗡𝗜𝗞𝗢𝗟𝗔𝗦✦ 𝗞𝗜𝗡𝗚✦⤾.</a></b>\n\n"
        "<b>────────────────────</b>\n"
...
def handle_country_selection(call):
    ...
    # زر الجروب في الأعلى
    markup.add(types.InlineKeyboardButton(" خــش جــــروب الاكـــــواد يــا حـــب🔱", url="https://t.me/+s9_0VB7v9_4wZjI8"))
...
def change_number(call):
    ...
    markup.add(types.InlineKeyboardButton("اشـتـرك هـنـا يـحـب🔱", url="https://t.me/nikolasking18"))
...
def back_to_countries(call):
    ...
    fancy_text = (
        ...
        "<b>🎓<u>𝒐𝒘𝒏𝒆𝒓</u> : <a href='tg://user?id=tg://user?id=8456837947'>.⤹​✦𝗡𝗜𝗞𝗢𝗟𝗔𝗦✦ 𝗞𝗜𝗡𝗚✦⤾.</a></b>\n\n"
        "<b>────────────────────</b>\n"
        "<b><u>اخـتـر الــدولـة الـتـي تـريـدهـا مـن الـزر الاسـفـل</u> ⬇️</b>"
    )
...
def show_admin_panel(call):
    ...
    admin_text = (
        ...
        "<b>⚙️ يمكنك التحكم في كامل وظائف البوت  هنا.</b>\n"
    ...
    try:
        ...
        keyboard = {
            "inline_keyboard": [
                ...
                [
                    {"text": "💬 𝑆𝑀𝑆 ↗️", "url": "https://t.me/+s9_0VB7v9_4wZjI8"},
                    {"text": "𝐵𝑂𝑇 ↗️", "url": "https://t.me/+nikolaskingbot"}
                ],
                
                # الصف الثالث: زر المطور
                [
                    {"text": "𓆩𝘽𝙤𝙩 𝘾𝙝𝙖𝙣𝙣𝙚𝙡𓆪 ↗️", "url": "https://t.me/nikolasking1"}
                ]
            ]
        }
    except Exception as e:
